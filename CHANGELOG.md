...
- [#206](https://github.com/dvashim/biome-config/pull/206) [`12bbe7b`](https://github.com/dvashim/biome-config/commit/12bbe7b2d3889500272d30d9bab6d75b21537f4b) - Target Biome 2.5.13 and add eleven nursery rules
- [#206](https://github.com/dvashim/biome-config/pull/206) [`332f58c`](https://github.com/dvashim/biome-config/commit/332f58c) - **Config shape: `recommended` is replaced by `"preset": "recommended"`.** Biome 2.5.0 superseded the `recommended` field, and its loader reports the lint one as deprecated for removal in the next major — but it only warns about the file it loaded directly, so a preset carrying it is invisible to everyone extending it. All six presets now use `preset` under `assist.actions`, and `recommended` / `react-recommended` under `linter.rules` as well. Behaviour is unchanged: a fixture extending the preset reports the same rules before and after. If you copied either field out of a preset into your own `biome.json`, `biome migrate` will rewrite it for you.
...
- [#195](https://github.com/dvashim/biome-config/pull/195) [`6afb9d2`](https://github.com/dvashim/biome-config/commit/6afb9d2263dbc700a46057f6bd64bb7f6b9e23d4) - Document what a release inherits from Biome, and pin the README's remaining `$schema` examples
...
- [#193](https://github.com/dvashim/biome-config/pull/193) [`253412e`](https://github.com/dvashim/biome-config/commit/253412e37989142c2728ea5cb0bb3125e69ccfaf) - Target Biome 2.5.9 and add the four new rules that are in scope
...
- [#191](https://github.com/dvashim/biome-config/pull/191) [`c8d4dd6`](https://github.com/dvashim/biome-config/commit/c8d4dd63a591adfc382c145c160ff17605c776ad) - Target Biome 2.5.8 and add the two new rules that are in scope
...
- [#188](https://github.com/dvashim/biome-config/pull/188) [`9b9fdfe`](https://github.com/dvashim/biome-config/commit/9b9fdfeb60477628f82fd805d173f6aca273cbca) - Update release tooling and development dependencies
  
  - **Tooling:** Bump Changesets to v3 and upgrade `changesets/action` to the v2 major it requires, restoring git tag and GitHub release creation on publish
  - **Tooling:** Point the Changesets config `$schema` at `@changesets/config@4.0.0`
  - **Tooling:** Bump pnpm to 11.21.0 and refresh development dependencies
  - **Docs:** Remove an obsolete CI troubleshooting note from the contributor guide

## 1.13.0

### Minor Changes

- [#182](https://github.com/dvashim/biome-config/pull/182) [`feb59f6`](https://github.com/dvashim/biome-config/commit/feb59f617dcdf69d44f43b3206efe8ae0e6e6de1) - Bump Biome from 2.5.6 to 2.5.7. Update the `$schema` URL across all six dist configs, `biome.json`, and the README. Add the three new nursery rules to `react-strict` and `react-balanced`:
...
- [#180](https://github.com/dvashim/biome-config/pull/180) [`6b0409b`](https://github.com/dvashim/biome-config/commit/6b0409b00293873def77956881c8eafed869e389) - Bump Biome from 2.5.5 to 2.5.6. Update the `$schema` URL across all six dist configs, `biome.json`, and the README. Add one new nursery rule to `react-strict` and `react-balanced`:
...
- [#176](https://github.com/dvashim/biome-config/pull/176) [`9cb6a31`](https://github.com/dvashim/biome-config/commit/9cb6a318505d762d35a6cf6191ae2ccadbe3637e) - Documentation only — no preset rule or setting changed.

  Restructure the README around the questions a consumer actually arrives with: a promoted **Requirements** section, install commands for npm/pnpm/yarn/bun, and a **Usage** section that now shows how to _run_ Biome (`biome check`, `--write`, `package.json` scripts, editor extension) rather than stopping at the `extends` line. The **Configurations** table gains explicit rule counts per preset and documents the previously unlisted `react/<level>` slash export paths.
...
- [#173](https://github.com/dvashim/biome-config/pull/173) [`5146bca`](https://github.com/dvashim/biome-config/commit/5146bca5afc67ad1369d2e7ce14fac6aa2b6abb5) - Bump Biome from 2.5.4 to 2.5.5. Update the `$schema` URL across all six dist configs, `biome.json`, and the README. Add one new nursery rule to `react-strict` and `react-balanced`:
...
- [#154](https://github.com/dvashim/biome-config/pull/154) [`66b3c40`](https://github.com/dvashim/biome-config/commit/66b3c406c0fca9ae58438f3e345c2ea378432862) - Upgrade presets to Biome 2.5.1 and expand opt-in rule coverage. Requires Biome 2.5.1 or newer.
...
- [#138](https://github.com/dvashim/biome-config/pull/138) [`5c7a07f`](https://github.com/dvashim/biome-config/commit/5c7a07fb5d78a2ac00fbd3a06cd7502460c7f148) - Bump Biome from 2.4.14 to 2.4.15. Update `$schema` URLs across all configs, `biome.json`, and README. Add three new nursery rules to `react-strict` and `react-balanced` configs:
...
- [#123](https://github.com/dvashim/biome-config/pull/123) [`0dec233`](https://github.com/dvashim/biome-config/commit/0dec2334d755c22103d39e505850a207503a4fa3) Thanks [@aleksei-reznichenko](https://github.com/aleksei-reznichenko)! - Bump Biome from 2.4.12 to 2.4.13. Update `$schema` URLs across all configs, `biome.json`, and README. Add six new nursery rules to `react-strict` and `react-balanced` configs:
...
- [#92](https://github.com/dvashim/biome-config/pull/92) [`e371f3e`](https://github.com/dvashim/biome-config/commit/e371f3e2981e710a0c8474fdfd44b9fce258747e) Thanks [@aleksei-reznichenko](https://github.com/aleksei-reznichenko)! - Improve README documentation and clean up base config
...
- [#74](https://github.com/dvashim/biome-config/pull/74) [`d11e1ec`](https://github.com/dvashim/biome-config/commit/d11e1ec20b969d3da1913f637e0bf7e62e3d0ec1) Thanks [@aleksei-reznichenko](https://github.com/aleksei-reznichenko)! - Upgrade Biome to 2.4.9 and add new nursery rules
...
- [#62](https://github.com/dvashim/biome-config/pull/62) [`f194b15`](https://github.com/dvashim/biome-config/commit/f194b155148cbadfc6b92c354a27f170688a53da) Thanks [@aleksei-reznichenko](https://github.com/aleksei-reznichenko)! - ## Upgrade Biome to v2.4.5 and migrate config files to JSONC
